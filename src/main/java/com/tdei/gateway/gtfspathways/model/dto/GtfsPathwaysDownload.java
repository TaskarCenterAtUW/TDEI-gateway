...
public class GtfsPathwaysDownload {
    ...
    @Schema(required = true, example = "5e991e7a-5c16-4ebf-ad31-3a3625bcca10", description = "tdei-assigned station id. Represented as UUID. Station ids can be retrieved using the /api/v1/stations path.")
    ...
    @Schema(required = true, description = "date from which this file is valid", example = "2018-02-10T09:30Z")
    @NotNull
    @Valid
    ...
    @Schema(required = true, example = "/api/v1/gtfs-pathways/{tdei_record_id}", description = "The url from which this file can be downloaded.")
    @NotNull
