...
public class GtfsFlexDownload {
    ...
    @Schema(required = true, example = "5e991e7a-5c16-4ebf-ad31-3a3625bcca10", description = "tdei-assigned service id. Represented as UUID. Service ids can be retrieved using the /api/v1/services path.")
    ...
    @Schema(required = true, example = "2018-02-10T09:30Z", description = "date-time that data was collected")
    @NotNull
    @Valid
    ...
    @Schema(required = true, example = "/api/v1/gtfs-flex/{tdei_record_id}", description = "The url from which this file can be downloaded.")
    @NotNull
