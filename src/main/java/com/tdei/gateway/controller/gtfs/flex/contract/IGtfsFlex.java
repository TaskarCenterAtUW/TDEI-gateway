...
public interface IGtfsFlex {
    ...
    ResponseEntity<Void> getFlexFile(@Parameter(in = ParameterIn.PATH, description = "tdei_record_id for a file, represented as a uuid", required = true, schema = @Schema()) @PathVariable("tdei_record_id") String tdeiRecordId);
    ...
    @RequestMapping(value = "versions",
            produces = {"application/json"},
            method = RequestMethod.GET)
    ResponseEntity<PageableResponse<VersionSpec>> listFlexVersions();
    ...
    ResponseEntity<String> uploadFlexFile(@Parameter(in = ParameterIn.DEFAULT, description = "", required = true, schema = @Schema()) @Valid @RequestBody GtfsFlexUpload body);
