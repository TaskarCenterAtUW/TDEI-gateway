...
public interface IOsw {
    ...
    ResponseEntity<Void> getOswFile(@Parameter(in = ParameterIn.PATH, description = "tdei_record_id for a file, represented as a uuid", required = true, schema = @Schema()) @PathVariable("tdei_record_id") String tdeiRecordId);
    ...
    @RequestMapping(value = "versions",
            ...
            method = RequestMethod.GET)
    ResponseEntity<PageableResponse<VersionSpec>> listOswVersions();
    ...
    ResponseEntity<String> uploadOswFile(@Parameter(in = ParameterIn.DEFAULT, description = "", required = true, schema = @Schema()) @Valid @RequestBody OswUpload body);
